...
function () {
  ...
  CollectionView.prototype.render = function () {
    ...
    this.parent.innerHTML = ''; // Creo un nuevo template

    var templateElement = document.createElement('template'); // Itero dentro de los modelos de la colección

    for (var _i = 0, _a = this.collection.models; _i < _a.length; _i++) {
      var model = _a[_i]; // creo un elemento nuevo por cada modelo

      var itemParent = document.createElement('div'); // hago un render de ese modelo

      this.renderItem(model, itemParent); // Lo agrego a la lista de elementos renderizados de la colección
...
exports.View = void 0; // En este caso, View tiene parametros del tipo Model, que necesita un atributo del tipo K para saber cuales son esos parametros.
...
function () {
  function View(parent, model) {
    this.parent = parent;
    this.model = model;
    this.regions = {}; // Para poder captar los cambios realizados en set-age (o cualquier otro eventos)
  ...
  View.prototype.bindEvents = function (fragment) {
    ...
    var _loop_1 = function _loop_1(eventKey) {
      var _a = eventKey.split(':'),
          eventName = _a[0],
          selector = _a[1]; // busco todos los elementos del fragmento y le asocio el evento correspondiente al eventKey.
  ...
  View.prototype.onRender = function () {}; // render() transforma el string que tenemos en template y lo transforma en un elemento nuevo de parent,
  ...
  View.prototype.render = function () {
    ...
    this.parent.innerHTML = ''; // Agrego un nuevo elemento hijo
...
function () {
  function Eventing() {
    var _this = this; //Creo una propiedad events la cual va a almacenar todos los eventos que generemos con sus nombres y la funcion callback asociada
    ...
    this.on = function (eventName, callback) {
      var handler = _this.events[eventName] || []; //el evento puede ser undefined, en ese caso se devuelve un array vacio

      handler.push(callback); // se agrega el callback al array

      _this.events[eventName] = handler; // se agrega a la lista de eventos el nuevo evento con su callback asociada
    };
  }
...
},{}],"../../../../.nvm/versions/node/v14.19.1/lib/node_modules/parcel-bundler/node_modules/base64-js/index.js":[function(require,module,exports) {
'use strict'
...
},{}],"../../../../.nvm/versions/node/v14.19.1/lib/node_modules/parcel-bundler/node_modules/ieee754/index.js":[function(require,module,exports) {
...
},{}],"../../../../.nvm/versions/node/v14.19.1/lib/node_modules/parcel-bundler/node_modules/isarray/index.js":[function(require,module,exports) {
...
},{}],"../../../../.nvm/versions/node/v14.19.1/lib/node_modules/parcel-bundler/node_modules/buffer/index.js":[function(require,module,exports) {
...
},{"base64-js":"../../../../.nvm/versions/node/v14.19.1/lib/node_modules/parcel-bundler/node_modules/base64-js/index.js","ieee754":"../../../../.nvm/versions/node/v14.19.1/lib/node_modules/parcel-bundler/node_modules/ieee754/index.js","isarray":"../../../../.nvm/versions/node/v14.19.1/lib/node_modules/parcel-bundler/node_modules/isarray/index.js","buffer":"../../../../.nvm/versions/node/v14.19.1/lib/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"node_modules/axios/lib/helpers/toFormData.js":[function(require,module,exports) {
...
},{"../utils":"node_modules/axios/lib/utils.js","buffer":"../../../../.nvm/versions/node/v14.19.1/lib/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"node_modules/axios/lib/core/settle.js":[function(require,module,exports) {
'use strict';
...
},{}],"../../../../.nvm/versions/node/v14.19.1/lib/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
function () {
  function Model(attributes, events, sync) {
    ...
    this.events = events;
    this.sync = sync; // la sintaxis reducida para el metodo get on()... solo puede hacerse si en el constructor se pasa el parametro events.
...
function () {
  function Attributes(data) {
    ...
    this.data = data; // Para evitar tener que agregarle tipos distintos a la respuesta del metodo se usa un generico.
...
users.fetch();
},{"./views/UserList":"src/views/UserList.ts","./models/Collection":"src/models/Collection.ts","./models/User":"src/models/User.ts"}],"../../../../.nvm/versions/node/v14.19.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../.nvm/versions/node/v14.19.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.ts"], null)
